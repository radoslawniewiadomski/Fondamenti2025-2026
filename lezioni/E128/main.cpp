...
void* Film::operator new(size_t size)
{
    ...
    return ::operator new(size);//chiamata del'operatore new definito a livello globale
}


int main()
{
    // Creazione di un oggetto Film utilizzando l'overloading di operatore new
    Film* p = new Film("Matrix", 120, 1999);
    p->stampaFilm();
